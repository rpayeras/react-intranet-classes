...
class Modal extends FormBasicModal {
    constructor(props){
        ...
        this.headerRoomsTable = ['Hab','Reg', 'Ocupante', 'Fecha Entrada', 'Fecha Salida', 'Hora de llegada', 'Estado', 'AD', 'NI', 'CU', 'Comisión','Total'];
        this.timeouts = [];
    ...
    getCreditCard(){
        ...
        $.ajax({
            ...
            if(typeof data === "object"){
                ...
                that.cleanStateCC();
                Util.hideLoading('creditcard');     
                if(typeof data === "string"){
                    Util.showAlertError(data);
                }else{
                    Util.showAlertError();
                }
            }
                                ...
                                <div className='tab-pane p-2' id='creditcard' role='tabpanel'>
                                    <div className='form-group'>
                                        ...
                                        <div className="row p-3">
                                            <input type='password' className='form-control col-sm-3' name='password_pci' value={this.state.password_pci} onChange={this.handleInputGeneral} onKeyPress={this.handleInputPciPassword}/>
                                            <button type='button' className={'btn btn-primary col-sm-1 fa fa-'+this.state.iconLockCreditCard} onClick={this.getCreditCard} data-target="password_pci" />
