...
var _OutsideClickHandler = __webpack_require__(21);
...
var _toLocalizedDateString = __webpack_require__(31);

var _toLocalizedDateString2 = _interopRequireDefault(_toLocalizedDateString);

var _getResponsiveContainerStyles = __webpack_require__(27);
  ...
  _createClass(SingleDatePicker, [{
    ...
    value: function () {
      function onChange(dateString) {
        ...
        var newDate = this.beforeDateChange(dateString);
        newDate = (0, _toMomentObject2['default'])(newDate, this.getDisplayFormat());
    ...
    /*
    * Función personalizada para primary
    */

  }, {
    key: 'beforeDateChange',
    value: function () {
      function beforeDateChange(dateString) {
        switch (dateString) {
          case 'h':
            dateString = (0, _moment2['default'])();
            break;
          case 'm':
            dateString = (0, _moment2['default'])().add(1, 'd');
            break;
          case 'ayer':
            dateString = (0, _moment2['default'])().subtract(1, 'd');
            break;
        }

        switch (dateString.length) {
          case 6:
            dateString = (0, _moment2['default'])(dateString, ['DDMMYY', 'YYMMDD']);
            break;
        }
